...
//	By passing by reference, I'm allowing myself multiple returns without having them in the same variable

    /**
     * prepare part of the query column by reference
	 
	 $first_val   - Should I put in the WHERE, or use AND
	 $select_type - 'sssiiiii'
	 $column      - column_name
	 $value       - column value
...
//	params $arr_search_by associative array of column names and values

	public function select($arr_search_by=null)
	{
...
//	@return void
    ...
    public function create()
    {
        ...
        if(isset($this->password))         { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->password, 'password'); }
        if(isset($this->password_old))     { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->password_old, 'password_old'); }
        if(isset($this->first_name))       { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->first_name, 'first_name'); }
        if(isset($this->last_name))        { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->last_name, 'last_name'); }
        if(isset($this->email))            { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->email, 'email'); }
        if(isset($this->screen_name))      { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->screen_name, 'screen_name'); }
        if(isset($this->job_function))     { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->job_function, 'job_function'); }
        if(isset($this->phone_number))     { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->phone_number, 'phone_number'); }
        if(isset($this->phone_number_ext)) { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->phone_number_ext, 'phone_number_ext'); }
        if(isset($this->cell_number))      { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->cell_number, 'cell_number'); }
        if(isset($this->address))          { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->address, 'address'); }
        if(isset($this->address_2))        { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->address2, 'address2'); }
        if(isset($this->city))             { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->city, 'city'); }
        if(isset($this->state))            { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->state, 'state'); }
        if(isset($this->zip))              { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->zip, 'zip'); }
        if(isset($this->link))             { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->link, 'link'); }
        if(isset($this->active))           { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 'i',$this->active, 'active'); }
        if(isset($this->dont_send_email))  { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 'i',$this->dont_send_email, 'dont_send_email'); }
        if(isset($this->last_login))       { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',$this->last_login, 'last_login'); }
        if(isset($this->role_id))          { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 'i',$this->role_id, 'role_id'); }
        if(isset($this->client_id))        { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 'i',$this->client_id, 'client_id'); }
        if(isset($this->partner_id))       { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 'i',$this->partner_id, 'partner_id'); }
        if(isset($this->tag_id))           { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 'i',$this->tag_id, 'tag_id'); }

        if(isset($this->created))          { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',date( "Y-m-d H:i:s"),'created' ); }
        if(isset($this->modified))         { $this->prepareForInsert($placeholder, $arr_columns, $arr_type, $arr_param, 's',date( "Y-m-d H:i:s"),'modified' ); }
