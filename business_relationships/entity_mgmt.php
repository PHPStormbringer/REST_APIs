...
/* 
 *  name: __construct
 *  desc: Make a datase connection open log files
 *   
 *  
 */ public function __construct() 
    ...
    //  Get database connection object
        ...
        $this->myfile = fopen("logs/".$this->file_prefix."entity_mgmt.txt", "a") or die("Unable to open file!");
...
/*  
 *  name: process
 *  desc: process data that came in with the request
 *   
 *  
 ...
 *  desc: Takes an array and builds an html table around it
 *
 ...
 */ pivate function decode()
    ...
    //  if it's an array, then the payload was json, if count > 0, it's json with content
        ...
        else
        {
            ...
            $this->desc  = "File: entity_mgmt.php.<br />Function: decode.<br />Message:  Payload could not be converted from JSON to PHP.<br />";
 ...
 *  desc: Move values from decoded json array to local variables 
 *
 ...
 */ private function analyze()
    ...
    //  If one of the values in results is grer than zero, then I need to cycle through the users.  
 ...
 *  desc: Take the values to be inserted into the database, and make sure the right datatype and not dangerous
 ...
 *  desc: Mostly for inserts.  Make sure any required fields have values.  Check database schema
 *  
 ...
 *  desc: Get users object and assign db cxn.  This is mostly here to wall off error handling si the processing is more readable 
 *
 *  @assign $this->arr_sender['role_id']
 *  @return void|400
 *
 */ private function getSender()
    {
        ...
        //  bail out
            ...
            $this->desc  = "File: entity_mgmt.php.<br />Function: process.<br />Message:  Not An Authorized User.<br />";
 ...
 *  desc: See if this user already exists 
 *
 *  @param  $aUser array
 *
 *  @return void
...
/*
 *  name: processUsers
 *  desc: process all users one by one
 *
 *  @return void
 *
...
/*  
 *  name: checkPartnerConflict
 *  desc: check for a conflict between partner and client
 *
 *  @return void|401
 *
 ...
 *
 *  @assign $this->arr_partner_messages
 *
...
/*  
 *  name: redact_user
 *  desc: call m_user update method, set active flag to inactive 
 * 
 *  
 ...
 *        description param for if I want to send more detail in email
 *  
 *  @param $err int
